...
public class MemberProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int    avatarBg = getIntent().getIntExtra("member_avatar_bg", R.drawable.avatar_bg_gold);
        ...
        setText(R.id.tvMemberBio,       bio,
                "A passionate community member dedicated to making a lasting difference through consistent and generous giving.");
        ...
        // Update title
        setText(R.id.tvMemberTitle, name != null ? name + "'s Profile" : "Guardian Profile", "Guardian Profile");

        // Entrance animation on stats
        animateEntrance();
    }
    ...
    private void animateEntrance() {
        int[] ids = {R.id.tvMemberName, R.id.tvMemberRank,
