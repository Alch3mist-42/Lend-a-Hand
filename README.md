...
| Sibongakonke Ntsele(https://github.com/Sbongakonk3/) | Database/PHP — PostgreSQL schema, ERD, auth scripts, allocation logic, leaderboard API |
| Lufuno Pearl Moyo (https://github.com/Lufuno-pearl/) | Java logic layer (with significant support from Thando) |
